...
function Banner() {
    return (
        ...
        <marquee class = "marquee" behavior= "scroll" direction="left" scrollamount = "15" height = "20px">
           MIAMI BASED ASPIRING SOFTWARE ENGINEER* / FRONT END DEVELOPER* </marquee>
           <div/>
           <div className="right-sliding">
           <marquee class = "marquee" behavior="scroll" direction="right"  scrollamount = "20" height = "20px">
